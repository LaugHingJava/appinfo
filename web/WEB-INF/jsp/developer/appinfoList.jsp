                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <table id="datatable-responsive"
                                ...
                                <tbody>
                                <c:forEach var="appInfo" items="${pageUtil.list }" varStatus="status">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="dataTables_info" id="datatable-responsive_info"
                                 role="status" aria-live="polite">共${pageUtil.totalCount }条记录
                                ${pageUtil.currentPageNo }/${pageUtil.totalPageCount }页
                            </div>
                        </div>
                        <div class="col-sm-7">
                            <div class="dataTables_paginate paging_simple_numbers"
                                ...
                                <ul class="pagination">
                                    <c:if test="${pageUtil.currentPageNo > 1}">
                                    ...
                                    <c:if test="${pageUtil.currentPageNo < pageUtil.totalPageCount }">
                                        <li class="paginate_button "><a
                                                href="#"
                                                aria-controls="datatable-responsive" data-dt-idx="1"
                                                tabindex="0">下一页</a>
